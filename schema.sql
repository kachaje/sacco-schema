...
CREATE TABLE
  IF NOT EXISTS memberLoanDisbursement (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    memberLoanId INTEGER NOT NULL,
    description TEXT NOT NULL,
    date TEXT DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE
  IF NOT EXISTS memberLoanProcessingFee (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    memberLoanId INTEGER NOT NULL,
    date TEXT DEFAULT CURRENT_TIMESTAMP,
    amount REAL NOT NULL,
...
CREATE TABLE
  IF NOT EXISTS memberLoanReceipt (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE
  IF NOT EXISTS memberSavingDeposit (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    memberSavingId INTEGER NOT NULL,
    description TEXT NOT NULL,
    date TEXT DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE
  IF NOT EXISTS memberSavingInterest (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    memberSavingId INTEGER NOT NULL,
    description TEXT NOT NULL,
    date TEXT DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE
  IF NOT EXISTS memberSavingWithdrawal (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    memberSavingId INTEGER NOT NULL,
    description TEXT NOT NULL,
    date TEXT DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE
  IF NOT EXISTS memberSharesIdsCache (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
...
CREATE TABLE
  IF NOT EXISTS sharesDepositReceipt (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    memberSavingId INTEGER NOT NULL,
    description TEXT NOT NULL,
    date TEXT DEFAULT CURRENT_TIMESTAMP,
...
CREATE TABLE
  IF NOT EXISTS sharesDepositWithdraw (
    id INTEGER PRIMARY KEY AUTOINCREMENT,
    memberSavingId INTEGER NOT NULL,
    description TEXT NOT NULL,
    date TEXT DEFAULT CURRENT_TIMESTAMP,
