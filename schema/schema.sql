...
id INTEGER PRIMARY KEY AUTOINCREMENT,
name TEXT NOT NULL,
category TEXT NOT NULL CHECK (category IN ('Personal', 'Business', 'Agricultural', 'Emergency')),
...
title TEXT NOT NULL CHECK (title IN ('Mr', 'Mrs', 'Miss', 'Dr', 'Prof', 'Rev', 'Other')),
maritalStatus TEXT NOT NULL CHECK (maritalStatus IN ('Married', 'Single', 'Widowed', 'Divorced')),
...
relationship TEXT NOT NULL CHECK (relationship IN ('Spouse', 'Child', 'Sibling', 'Other')),
active INTEGER DEFAULT 1,
createdAt TEXT DEFAULT CURRENT_TIMESTAMP,
updatedAt TEXT DEFAULT CURRENT_TIMESTAMP,
FOREIGN KEY (memberId) REFERENCES member (id) ON DELETE CASCADE
...
highestQualification TEXT NOT NULL CHECK (highestQualification IN ('Tertiary', 'Secondary', 'Primary', 'None')),
active INTEGER DEFAULT 1,
createdAt TEXT DEFAULT CURRENT_TIMESTAMP,
updatedAt TEXT DEFAULT CURRENT_TIMESTAMP,
FOREIGN KEY (memberLoanId) REFERENCES memberLoan (id) ON DELETE CASCADE
